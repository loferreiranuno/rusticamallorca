<div class="row">
    ...
    @foreach(App\ContactStep::whereNotIn('name',['won','lost'])->get() as $step)
        <div class="col-xs-3 funnel-column" style="margin-bottom:10px;">
